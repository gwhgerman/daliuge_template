"""
daliuge_template appComponent module.

This is the module of daliuge_template containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/daliuge_template.MyApp/String/readonly/
