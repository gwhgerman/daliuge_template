"""
daliuge_template component module.

This is the module of daliuge_template containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/daliuge_template.MyData/String/readonly/
